    ...
    >
      ...
      <div className="px-12 text-my-silver md:text-lg">
        ...
        <p className="max-w-[750px]">
          ...
          then, I&apos;ve worked on my skills, learned JavaScript and front-end
          frameworks, building my foundations in front-end development.
          Transitioning to backend development, I started with Node.js and
          MongoDB. Combining these skills, I&apos;ve built some impressive
          projects. Below is the list of programming languages and frameworks I
          am proficient in:
        </p>
