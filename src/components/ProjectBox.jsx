...
const ProjectBox = ({ darkTheme, title, description, images }) => {
  return (
    <div
      className={`w-72 rounded-lg duration-300 ease-in-out hover:shadow-lg md:w-96 ${darkTheme ? "bg-gray-850" : "bg-white"}`}
    >
      ...
      <button className="group flex items-center px-4 pb-4 font-bold text-purple-600 hover:underline md:text-lg">
        <span>VIEW</span>
